...
# booleanos: Se utiliza para representar valores de verdad en la lógica.
mayor_edad = True
tiene_bigote = False

#  Números: Aquí podemos tener números enteros, decimales o complejos.
mayoria_edad = 18
altura = 1.72

# Strings: Se refiere a textos o cadenas de caracteres.
frase = "Anita lava la tina"


'''
Son colecciones compuestas de los datos primitivos vistos anteriormente.
'''
...
perro[2] = "comida de perro" #ERROR: Las tuplas no pueden ser modificadas
